...
![Minimum rustc version](https://img.shields.io/badge/rustc-1.70+-lightgray)
...
Make sure `rustc` is 1.70+ ([reason](https://crates.io/crates/pango/0.18.0)) and you have the following C libraries installed:
