...
Otherwise make sure `rustc` is 1.56+ ([reason](https://github.com/gtk-rs/gtk-rs-core/tree/master/cairo#minimum-supported-rust-version)) and you have the following C libraries installed:
