...
![Minimum rustc version](https://img.shields.io/badge/rustc-1.51+-lightgray)
...
Otherwise make sure `rustc` is 1.51+ ([reason](https://crates.io/crates/cairo-rs/0.14.9)) and you have the following C libraries installed:
